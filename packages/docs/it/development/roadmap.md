...
- Chat IA: connessione diretta OpenRouter, 86 strumenti in `packages/core/src/tools/`, ⌘J
- 60 strumenti IA/MCP aggiuntivi portati da figma-use (86 in totale)
- Server MCP (@open-pencil/mcp): stdio + HTTP, 86 strumenti core + 3 gestione file
...
- Schede multi-file: ⌘N/⌘T nuova scheda, ⌘W chiudi, ⌘O apri
