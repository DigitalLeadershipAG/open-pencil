...
| Strumenti IA | 🟡 | 89 strumenti via OpenRouter + server MCP; nessuna immagine generata da IA o ricerca IA ancora |
...
| Server MCP | ✅ | @open-pencil/mcp con trasporti stdio + HTTP; 86 strumenti core + 3 gestione file = 89 total |
