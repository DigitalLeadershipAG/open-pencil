...
| Herramientas IA | 🟡 | 89 herramientas vía OpenRouter + servidor MCP; sin imágenes generadas por IA ni búsqueda IA aún |
...
| Servidor MCP | ✅ | @open-pencil/mcp con transportes stdio + HTTP; 86 herramientas core + 3 de gestión de archivos = 89 total |
