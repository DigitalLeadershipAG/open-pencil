...
- Chat IA: conexión directa OpenRouter, 86 herramientas en `tools/`, ⌘J
- 60 herramientas IA/MCP adicionales portadas de figma-use (86 en total)
- Servidor MCP (@open-pencil/mcp): stdio + HTTP, 86 herramientas core + 3 de gestión de archivos
- Definiciones de herramientas unificadas: definir una vez en `tools/`, adaptar para chat IA (valibot), MCP (zod), CLI (eval)
