...
Wbudowany asystent AI przez <kbd>⌘</kbd><kbd>J</kbd>. **89 narzędzi** w `packages/core/src/tools/` obejmujących: odczyt, tworzenie, modyfikację, manipulację węzłów, CRUD zmiennych, narzędzia wektorowe, kontrolę viewportu i `eval`. **Serwer MCP** udostępnia 89 narzędzi łącznie (86 core + 3 zarządzanie plikami) dla zewnętrznych narzędzi kodowania AI.
