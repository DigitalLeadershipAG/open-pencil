...
| Narzędzia AI | 🟡 | 89 narzędzi przez OpenRouter + serwer MCP; bez obrazów generowanych przez AI ani wyszukiwania AI jeszcze |
...
| Serwer MCP | ✅ | @open-pencil/mcp z transportami stdio + HTTP; 86 narzędzi core + 3 zarządzanie plikami = 89 total |
