...
- Chat AI: bezpośrednie połączenie OpenRouter, 86 narzędzi w `tools/`, ⌘J
- 60 dodatkowych narzędzi AI/MCP przeniesionych z figma-use (86 łącznie)
- Serwer MCP (@open-pencil/mcp): stdio + HTTP, 86 narzędzi core + 3 zarządzanie plikami
- Ujednolicone definicje narzędzi: zdefiniuj raz w `tools/`, adaptuj dla chatu AI (valibot), MCP (zod), CLI (eval)
