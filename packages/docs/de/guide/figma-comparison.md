...
| KI-Werkzeuge | 🟡 | 89 Werkzeuge via OpenRouter + MCP-Server; noch keine KI-generierten Bilder oder KI-Suche |
...
| MCP-Server | ✅ | @open-pencil/mcp mit stdio + HTTP-Transporten; 86 Kern-Werkzeuge + 3 Dateiverwaltung = 89 gesamt |
