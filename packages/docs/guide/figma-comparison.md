...
| AI tools | 🟡 | 89 tools via OpenRouter + MCP server; no AI-generated images or AI-powered search yet |
...
| MCP server | ✅ | @open-pencil/mcp with stdio + HTTP transports; 86 core tools + 3 file management tools = 89 total |
