...
| Outils IA | 🟡 | 89 outils via OpenRouter + serveur MCP ; pas d'images générées par IA ni de recherche IA encore |
...
| Serveur MCP | ✅ | @open-pencil/mcp avec transports stdio + HTTP ; 86 outils core + 3 gestion de fichiers = 89 total |
